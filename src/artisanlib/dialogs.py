...
class HelpDlg(ArtisanDialog):
    def __init__(self, parent:QWidget, aw:'ApplicationWindow', title:str = '', content:str = '') -> None:
        ...
        homeLabel = QLabel()
        homeLabel.setText(f"{QApplication.translate('Label', 'For more details visit')} <a href='https://github.com/BrendenWalker/kaleido_scope'>github.com/BrendenWalker/kaleido_scope</a>")
